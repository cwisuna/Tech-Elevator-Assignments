...
SELECT city_name as city, state_abbreviation as state, population
from city;
...
SELECT c.city_name as city, c.state_abbreviation as state, c.population
from city as c;
...
FROM city
WHERE state_abbreviation IN ('CT', 'ME', 'MA', 'MH', 'RI', 'VT');
...
SELECT park_name, area, (area * 1000) as area_in_kilometers
FROM park;
