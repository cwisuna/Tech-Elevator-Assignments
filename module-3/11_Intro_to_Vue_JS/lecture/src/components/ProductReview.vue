    ...
    <div class="well-display">
        <div class="well">
         ...
         <div class="well">
            ...
            2 Star Review{{numberOfTwoStarReviews === 2 ? '': 's'}}
        </div>
        <div class="well">
            <span class="amount">{{numberOfThreeStarReviews}}</span>
            3 Star Review{{numberOfThreeStarReviews === 3 ? '': 's'}}
        </div>
        <div class="well">
            <span class="amount">{{numberOfFourStarReviews}}</span>
            4 Star Review{{numberOfFourStarReviews === 4 ? '': 's'}}
        </div>
        <div class="well">
            <span class="amount">{{numberOfFiveStarReviews}}</span>
            5 Star Review{{numberOfFiveStarReviews === 5 ? '': 's'}}
        </div>
    </div>
